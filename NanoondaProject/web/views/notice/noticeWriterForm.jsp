...
<div id="ad_listview"> <!-- 전체 묶은 div : start -->	
   <h1 class="ad_pagetit"><span>Notice Management</span>공지사항 작성 페이지</h1>

   <form method="post" action="/nnd/qinsert"enctype="multipart/form-data">
