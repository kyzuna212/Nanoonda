...
<body>   
 ...
 <div id="ad_listview"> <!-- 전체 묶은 div : start -->	
   ...
   <form method="post" action="/nnd/qrinsert"enctype="multipart/form-data"> <!--  qr로 바꿈 -->
 ...
 <table class="ad_uptable" align="center" width="500" border="1" cellspacing="0" cellpadding="5">
      ...
      <tr class="adtablenone">
         ...
         <input type="hidden" value=<%=qnaNum%>" name="qno"> <!-- 여기 추가 -->
         <input type="reset" value="작성취소"> &nbsp;
         <input type="button" value="목록" onclick="javascript:location.href='/nnd/qslist?page=">
         </th>
      </tr>
   </table>
   </form>
