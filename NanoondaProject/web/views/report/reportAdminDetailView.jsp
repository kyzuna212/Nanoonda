...
<input type="button" id="reportcom" value="해당 게시글로가기" onclick="javascript:location.href='/nnd/rsimplech?rno=<%=report.getReportNo() %>'" style="cursor:pointer; ">
<input type="hidden" value="" name="writeno">
</div>
</th></tr>
</table>
