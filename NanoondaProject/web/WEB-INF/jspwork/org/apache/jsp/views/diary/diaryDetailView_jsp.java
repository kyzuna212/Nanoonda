 ...
 * Generated at: 2020-08-17 01:49:38 UTC
...
public final class diaryDetailView_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/views/diary/../../views/common/meta.jsp", Long.valueOf(1597472488000L));
    _jspx_dependants.put("/views/diary/../../views/common/footer.jsp", Long.valueOf(1597297930000L));
    _jspx_dependants.put("/views/diary/../common/header.jsp", Long.valueOf(1597473954000L));
  }
  ...
  static {
    ...
    _jspx_imports_classes.add("diary.model.vo.Diary");
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	int currentPage = ((Integer)request.getAttribute("currentPage")).intValue();
      ...
      out.write("\r\n");
      out.write("<script>\r\n");
      out.write("//댓글 테이블 좋아요/싫어요 오버시 컬러변경\r\n");
      out.write("$(document).ready(function(){\r\n");
      out.write("\t$(\"#likebtn img\").mouseover(function(){\r\n");
      out.write("\t\t$(this).attr(\"src\", \"/nnd/resources/images/like_on.png\");\r\n");
      out.write("\t});\r\n");
      out.write("\t$(\"#likebtn img\").mouseout(function(){\r\n");
      out.write("\t\t$(this).attr(\"src\", \"/nnd/resources/images/like_off.png\");\r\n");
      out.write("\t});\r\n");
      out.write("\t\r\n");
      out.write("\t$(\"#hatebtn img\").mouseover(function(){\r\n");
      out.write("\t\t$(this).attr(\"src\", \"/nnd/resources/images/hate_on.png\");\r\n");
      out.write("\t});\r\n");
      out.write("\t$(\"#hatebtn img\").mouseout(function(){\r\n");
      out.write("\t\t$(this).attr(\"src\", \"/nnd/resources/images/hate_off.png\");\r\n");
      out.write("\t});\r\n");
      out.write("});\r\n");
      out.write("</script>\r\n");
      out.write("</head>\r\n");
   ...
   Member loginMember = (Member)session.getAttribute("loginMember");
      ...
      out.write("            <span class=\"btn\" id=\"postbtn\"><a href=\"/nnd/rlist?page=1\"><img src=\"/nnd/resources/images/post_off.png\"></a></span>\r\n");
      ...
      out.write("</html>");
      out.write("\r\n");
      out.write("\t<h1 class=\"subtit\"><span>Open Diary</span>오픈 다이어리</h1>\r\n");
      out.write("\t<div class=\"writecon\">\r\n");
      out.write("\t<!-- 일기 상세보기 테이블 -->\t\t\r\n");
      out.write("\t<table class=\"dt\" id=\"diarydetail\" align=\"center\">\t\t\r\n");
      out.write("\t\t<tr><th>제목</th><td>");
      out.print( diary.getDiaryTitle() );
      out.write("</td></tr>\r\n");
      out.write("\t\t<tr><th>작성자</th><td>");
      out.print( diary.getDiaryWriter() );
      out.write("</td></tr>\r\n");
      out.write("\t\t<tr><th>작성일</th><td>");
      out.print( diary.getDiaryDate() );
      out.write("</td></tr>\r\n");
      out.write("\t\t<tr><td colspan=\"2\" id=\"contentarea\">\r\n");
      out.write("\t\t\t");
 if(diary.getDiaryOriginfile() != null) {
      out.write("\r\n");
      out.write("\t\t\t\t\t<img src=\"/nnd/resources/dupimages/");
      out.print( diary.getDiaryRenamefile() );
      out.write("\"><br><br>\t\t\r\n");
      out.write("\t\t\t\t");
 }else{ } 
      out.write("\r\n");
      out.write("\t\t\t");
      out.print( diary.getDiaryContent() );
      out.write("</td>\r\n");
      out.write("\t\t</tr>\r\n");
      out.write("\t\t<tr>\r\n");
      out.write("\t\t\t\t<td colspan=\"2\" align=\"center\">\r\n");
      out.write("\t\t\t\t<a href=\"/nnd/rduple.u?dno=");
      out.print(diary.getDiaryNo() );
      out.write("&dwriter=");
      out.print( diary.getDiaryWriter() );
      out.write("\"><img src=\"/nnd/resources/images/report.png\"></a> \r\n");
      out.write("\t\t\t\t</td>\r\n");
      out.write("        </tr>\r\n");
      out.write("        <tr>\t\t\t            \r\n");
      out.write("            <td colspan=\"2\" class=\"button\" align=\"center\">\r\n");
      out.write("            \t");
 if(loginMember.getnName().equals(diary.getDiaryWriter())){ 
      out.write("\r\n");
      out.write("            \t<input type=\"button\" value=\"수정\" class=\"bottomb\" onclick=\"javascript:location.href='/nnd/dupview?dno=");
      out.print( diary.getDiaryNo() );
      out.write("&page=");
      out.print( currentPage );
      out.write("&openOk=");
      out.print( diary.getOpenOk() );
      out.write("'\">\r\n");
      out.write("            \t<input type=\"button\" value=\"삭제\" class=\"bottomb\" onclick=\"javascript:location.href='/nnd/ddel?dno=");
      out.print( diary.getDiaryNo() );
      out.write("&openOk=");
      out.print( diary.getOpenOk() );
      out.write("'\">\r\n");
      ...
      out.write("\r\n");
      out.write("                <input type=\"button\" value=\"목록\" class=\"bottomb\" onclick=\"javascript:location.href='/nnd/dlist?page=");
      out.print( currentPage );
      out.write("'\">\r\n");
      out.write("            </td>\r\n");
      out.write("\t\t</tr>  \t\r\n");
      out.write("\t</table>\r\n");
      out.write("\t<!-- 일기 상세보기 테이블 끝 -->\r\n");
      out.write("\t\r\n");
      out.write("\t<!-- 댓글 작성 테이블 -->\t\t\r\n");
      out.write("\t<form id=\"writeform\" method=\"post\" action=\"/nnd/rinsert\">\r\n");
      ...
      out.print( currentPage );
      out.write("\">\r\n");
      out.write("\t\t<textarea id=\"rcontent\" name=\"content\" placeholder=\"당신의 예쁜 마음을 나눠주세요. (비추천 5개 누적 시 자동으로 댓글이 삭제됩니다.)\" tabindex=\"1\" style=\"width:800px; margin:10px;\"></textarea>\r\n");
      out.write("\t\t<input type=\"submit\" class=\"bottomb\" value=\"댓글달기\">\r\n");
      out.write("\t</form>\r\n");
      out.write("\t<!-- 댓글 작성 테이블 끝 -->\t\r\n");
      out.write("\t\r\n");
      out.write("\t\r\n");
      out.write("\t<!-- 댓글 출력 테이블 -->\r\n");
      out.write("\t<ul class=\"list_reply\">\r\n");
      out.write("\t\t");
 for(Reply r : replyList){ 
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t<li class=\"rlist_print\">\t\t\t\r\n");
      out.write("\t\t\t\t<span class=\"reply_content\">\r\n");
      out.write("\t\t\t\t\t<span id=\"rr_nickname\">");
      out.print( r.getReplyWriter() );
      out.write("</span>\r\n");
      out.write("\t\t\t\t\t<span id=\"rr_content\">");
      out.print( r.getReplyContent() );
      out.write("</span>\r\n");
      out.write("\t\t\t\t\t<span id=\"rr_date\">");
      out.print( r.getReplyDate() );
      out.write("</span>\r\n");
      out.write("\t\t\t\t\t<span id=\"likehate\" class=\"likehate\">\r\n");
      out.write("\t\t\t\t\t\t<span class=\"lhbtn\" id=\"likebtn\"><a href=\"/nnd/like?rno=");
      out.print( r.getReplyNo() );
      out.write("&dno=");
      out.print( r.getDiaryNo() );
      out.write("&page=");
      out.print( currentPage );
      out.write("&counter=");
      out.print( loginMember.getId() );
      out.write("\">\r\n");
      out.write("\t\t\t\t\t\t\t<img src=\"/nnd/resources/images/like_off.png\"></a>");
      out.print( r.getLikeCount() );
      out.write("</span>\r\n");
      out.write("\t\t\t\t\t\t<span class=\"lhbtn\" id=\"hatebtn\"><a href=\"/nnd/hate?rno=");
      out.print( r.getReplyNo() );
      out.write("&dno=");
      out.print( r.getDiaryNo() );
      out.write("&hateCount=");
      out.print( r.getHateCount() );
      out.write("&page=");
      out.print( currentPage );
      out.write("&counter=");
      out.print( loginMember.getId() );
      out.write("\">\r\n");
      out.write("\t\t\t\t\t\t\t<img src=\"/nnd/resources/images/hate_off.png\"></a>");
      out.print( r.getHateCount() );
      out.write("</span>\r\n");
      out.write("\t\t\t\t\t</span>\r\n");
      out.write("\t\t\t\t</span>\r\n");
 ...
 if(loginMember.getnName().equals(r.getReplyWriter())){ 
      out.write("\r\n");
      out.write("\t\t\t\t<div class=\"my_edit\">\r\n");
      out.write(" \t\t\t\t\t<a href=\"/nnd/rupview?rno=");
      out.print( r.getReplyNo() );
      out.write("&page=");
      out.print( currentPage );
      out.write("\" class=\"edit\">수정</a>\r\n");
      out.write("\t\t\t\t\t<a href=\"/nnd/rdel?rno=");
      out.print( r.getReplyNo() );
      out.write("&dno=");
      out.print( r.getDiaryNo() );
      out.write("&page=");
      out.print( currentPage );
      out.write("\" class=\"edit\">삭제</a>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t");
 } 
      out.write("\r\n");
